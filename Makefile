# This Makefile is for the NG extension to perl.
#
...
#     BUILD_REQUIRES => { Test::More=>q[0], Test::Deep=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[Artistic_2_0]
#     MIN_PERL_VERSION => q[5.01]
#     NAME => q[NG]
#     PL_FILES => {  }
#     PREREQ_PM => { Spreadsheet::ParseExcel=>q[0], autobox=>q[0], autodie=>q[0], Test::Deep=>q[0], DBI=>q[0], SQL::Abstract=>q[0], HTML::TreeBuilder::XPath=>q[0], Try::Tiny=>q[0], HTML::Element=>q[5.00], Child=>q[0], Time::HiRes=>q[0], AnyEvent::HTTP=>q[0], Test::More=>q[0], Spreadsheet::WriteExcel=>q[0], HTML::Selector::XPath=>q[0], File::Copy::Recursive=>q[0] }
#     VERSION_FROM => q[lib/NG.pm]
#     clean => { FILES=>q[NG-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/chenryn/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
TO_INST_PM = lib/NG.pm \
	lib/NG/Array.pm \
	lib/NG/Autobox.pm \
	lib/NG/Autobox/Number.pm \
	lib/NG/Autobox/String.pm \
	lib/NG/Class.pm \
	lib/NG/DB.pm \
	lib/NG/EMail.pm \
	lib/NG/Excel.pm \
	lib/NG/Excel/Cell.pm \
	lib/NG/Excel/Sheet.pm \
	lib/NG/File.pm \
	lib/NG/HTTP/Client.pm \
	lib/NG/HTTP/DOM.pm \
	lib/NG/Hashtable.pm \
	lib/NG/Log.pm \
	lib/NG/Log/IPMatcher.pm \
	lib/NG/Object.pm \
	lib/NG/SHashtable.pm \
	lib/NG/System.pm \
	lib/NG/Time.pm

PM_TO_BLIB = lib/NG/Log/IPMatcher.pm \
	blib/lib/NG/Log/IPMatcher.pm \
	lib/NG/Class.pm \
	blib/lib/NG/Class.pm \
	lib/NG/Excel/Cell.pm \
	...
	lib/NG/Autobox/String.pm \
	blib/lib/NG/Autobox/String.pm \
	lib/NG/Object.pm \
	blib/lib/NG/Object.pm \
	lib/NG/Autobox.pm \
	blib/lib/NG/Autobox.pm \
	lib/NG/File.pm \
	blib/lib/NG/File.pm \
	lib/NG/Excel.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  ...
	  lib/NG/Log.pm $(INST_MAN3DIR)/NG::Log.$(MAN3EXT) \
	  lib/NG/Time.pm $(INST_MAN3DIR)/NG::Time.$(MAN3EXT) \
	  lib/NG/HTTP/DOM.pm $(INST_MAN3DIR)/NG::HTTP::DOM.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    AnyEvent::HTTP:       0' >> META_new.yml
	$(NOECHO) $(ECHO) '    autobox:              0' >> META_new.yml
	$(NOECHO) $(ECHO) '    autodie:              0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Child:                0' >> META_new.yml
	$(NOECHO) $(ECHO) '    DBI:                  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    File::Copy::Recursive:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    HTML::Element:        5.00' >> META_new.yml
	$(NOECHO) $(ECHO) '    HTML::Selector::XPath:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    HTML::TreeBuilder::XPath:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    perl:                 5.01' >> META_new.yml
	$(NOECHO) $(ECHO) '    Spreadsheet::ParseExcel:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="AnyEvent::HTTP" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Child::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBI::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="File::Copy::Recursive" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTML::Element" VERSION="5" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTML::Selector::XPath" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="autobox::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/NG/Log/IPMatcher.pm blib/lib/NG/Log/IPMatcher.pm \
	  lib/NG/Class.pm blib/lib/NG/Class.pm \
	  lib/NG/Excel/Cell.pm blib/lib/NG/Excel/Cell.pm \
	  lib/NG/SHashtable.pm blib/lib/NG/SHashtable.pm \
	  lib/NG/DB.pm blib/lib/NG/DB.pm \
	  lib/NG.pm blib/lib/NG.pm \
	  lib/NG/Log.pm blib/lib/NG/Log.pm \
	  lib/NG/Hashtable.pm blib/lib/NG/Hashtable.pm \
	  lib/NG/Autobox/String.pm blib/lib/NG/Autobox/String.pm \
	  lib/NG/Object.pm blib/lib/NG/Object.pm \
	  ...
	  lib/NG/Array.pm blib/lib/NG/Array.pm \
	  lib/NG/Autobox/Number.pm blib/lib/NG/Autobox/Number.pm \
	  lib/NG/HTTP/DOM.pm blib/lib/NG/HTTP/DOM.pm 
